#Tamaguino  
<b>(Original design by Alojz Jakob)</b>

![](img/Complete_1.jpg)![](img/Complete_2.jpg)
...
|Material|Quantity|
|-|-|
|[Arduino Pro Mini](https://www.diyelectronics.co.za/store/boards/1501-arduino-pro-mini-v2-5v16mhz-328p.html)  |1
|[4cm x 6cm prototyping PCB](https://www.diyelectronics.co.za/store/prototyping/1345-universal-pcb-prototyping-kit.html)  |1
|LiPo rechargeable battery 720 mAh  |1
|[Micro USB LiPo charging circuit](https://www.diyelectronics.co.za/store/battery-charger/1195-1a-lithium-battery-charging-module.html) |1 
|[128x64 OLED Display](https://www.diyelectronics.co.za/store/displays/1432-oled-display-module-white-096-inch-128x64-4pin-i2c-iic-for-arduino.html)  |1
|[Buzzer](https://www.diyelectronics.co.za/store/audio/1804-ky-012-active-buzzer-module.html?search_query=buzzer&results=18)  |1
|[Push Buttons](https://www.diyelectronics.co.za/store/buttons-switches/1988-tactile-43mm-horizontal-small-button.html) |3
|[10K Resistors](https://www.diyelectronics.co.za/store/resistors/1582-resistor-10k-ohm-14w-5.html) | 3
|[Jumper wires](https://www.diyelectronics.co.za/store/connectors-wiring/258-male-to-female-sil-jumper-wires.html)  | 9
|Small on/off switch    | 1
|Soldering iron | Optional
|Solder | Optional
|[Tamaguino case](http://www.thingiverse.com/thing:2120692)| Optional



##Diagram
![](img/Tamaguino_bb.jpg)

##Instruction

1. Solder the bottom row of your button to the bottom row of your PCB as shown in the image below. Your bottom row of pins for your buttons will all be grounded
   ![](img/Button_grounding.jpg)
   <b>The image above shows how you can ground your buttons without clutter around the GND pin on your Pro Mini</b>
2. Solder your resistors to the slots next to each of your button's signal pins as shown in the image below, and bridge the solder to your button pins.
   ![](img/Button_signal.jpg)
   <b> The image above shows where you can solder your buttons as well as the resistors for an easy layout.</b>
3. Next you will solder your Pro Mini to the OTHER SIDE of the PCB, try to place your Pro mini about 3 rows above the top pins of your buttons, solder at pin 7, 8, 9, A4, A5, GND and VCC as shown in the image below.
   ![](img/Pro_mini_layout.jpg)
   <b> The image above shows placement of the Pro Mini as well as highlights the pins for the OLED.</b>
4. You will now solder the resistors connected to your top signal pins to the respective pins for the code, we used pin 7, 8 and 9 on our Pro Mini
3.  Solder your OLED display to the PCB just above the buttons, so that your OLED pins peak out just above your Pro Mini – as shown by the orange circle in the image above.
4. Stick down your LiPo charging module to the top of your PCB.
5. With your basic components now attached to the PCB, you can start wiring. Solder a wire from pin A4 to the SDA pin on your OLED (shown in blue on the diagram and orange in the images)
6.  Solder a wire from pin A5 to SCL pin on your OLED (shown in yellow in the diagram and red in the images)
7. Connect GND on your OLED to GND on your mini, and then connect VCC to VCC.
8. You can now solder your buzzer onto your board as shown in the image. Solder one pin to pin 6 and the other to GND.
9. On your LiPo charging module, solder one wire from OUT- to GND, and then solder another wire from OUT+ to one side of your switch – as shown in the image below.
10. Solder the red wire (V) to B+ on your charging module and the brown/black wire (G) to B- as shown in the image below.
    ![](img/Lipo_wires.jpg)
11. Finally, ground the other side of your switch by connecting a GND pin to the GND pin on the microcontroller.

##Code

The original code for this project can be found at [Alojz Jakob's Tamaguino page](https://alojzjakob.github.io/Tamaguino/) we have modified the code to save the stats of our dinosaur with a save button.
The stats are saved on the EEPROM of our Arduino Pro Mini.
You can find our editted version of the code below.

[Tamaguino_EEPROM DOWNLOAD](Tamaguino_EEPROM.ino)
~~~
